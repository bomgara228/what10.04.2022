...
const float PLAYER_SPEED_Y = 5.5f;
const size_t METEOR_TYPE_QTY = 8;
const size_t METEORS_QTY = 20; 
const std::string BIG_LASER_FILE_NAME = "laserGreen04.png";
const std::string BAD_LASER_FILE_NAME = "laserRed03.png";
const float LASER_SPEED = -10.f;
const float RIGHT2_LASER_SPEED = 1.5f;
const float LEFT2_LASER_SPEED = -1.5f;
const float LEFT4_LASER_SPEED = -3.f;
const float RIGHT4_LASER_SPEED = 3.f;
const float LEFT_BAD_LASER_SPEED = 17.f;
const float RIGHT_BAD_LASER_SPEED = -17.f;
const float BAD_LASER_SPEED = -19.f;
const int PLAYER_HP = 100;
const std::string BAD_SHIP = "bad.png";
const std::string LIVES_ICON = "lives.png";
const std::string HP_BAR = "hp_bar.png";
const std::string GAME_OVER_FILE_NAME = "game-over.jpg";
const size_t BONUS_TYPES_QTY = 7;